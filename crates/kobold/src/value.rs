...
impl_text! {
    text_node [&str, &String, &Ref<str>, &Ver<String>]
...
impl_value!(&'a str: &str, &String, &Ref<str>, &Ver<String>);
...
impl_text_view!(&str, &String, &Box<str>, &Ref<str>, &Ver<String>);
