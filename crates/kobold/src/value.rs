...
use crate::diff::{Diff, Ref, VString, Ver};
...
impl_text! {
    text_node [&str, &String, &Ref<str>, &VString, &Ver<String>]
...
impl_value!(&'a str: &str, &String, &Ref<str>, &VString, &Ver<String>);
...
impl_text_view!(&str, &String, &Ref<str>, &VString, &Ver<String>);
